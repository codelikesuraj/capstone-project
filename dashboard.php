<?php
include("config/getAllStudent.php");
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="container-fluid container-bound">
    ...
    <div class="col-12">
      <span class="col-sm-3" style="margin-bottom:8px">
        <input type="text" id="name" class="form-control" placeholder="Search Record By Name Only" onkeyup="searchByName()" required="required" autocomplete="off">
      </span>
      <span class="col-sm-3">
      ...
      <span class="col-sm-6" style="margin-bottom:8px">
        <span class="col-sm-5">
          <select class="form-control" id="gender" onchange="searchByGender()" required="required">
        ...
        <span class="col-sm-4">
          <input type="number" id="score" class="form-control" placeholder="Enter Jamb Score" required="required" autocomplete="off" onkeyup="searchByJambScore()">
        </span>
        <span class="col-sm-3">
          <input type="button" class="btn-primary form-control" value="search">
        </span>
      </span>
    </div>
